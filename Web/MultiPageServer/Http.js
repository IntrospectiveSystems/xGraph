...
(function Http() {
	...
	async function AddRoute(com, fun) {
		str = "";
		for(let i = 0; i < 128; i ++) str += 'QWERTYUIOPASDFGHJKLZXCVBNM1234567890+=-_,<.>/?;:!@#$%^&*()'.charAt(((Math.random() * 10e6)%1)*58);

		if('Tag' in com) {
			log.w('Passing Tag to Addroute is deprecated. Tag is autogenerated and passed back.');
		}
		this.Par.ApexList[com.Tag || str] = com.Pid;
		com.Tag = com.Tag || str;
