(function World() {
	...
	function SetProprty(com, fun) {
		let key = com.Variable || com.Name || com.Property || "null";
		let val = com.Value;
		this.Par.Properties[key] = val;
	}

	function GetProperty(com, fun) {
		let key = com.Variable || com.Name || com.Property || "null";
		if(key in this.Par.Properties) {
			com.Value = this.Par.Properties[key];
			fun(null, com);
			return;
		}
		if('Default' in com) {
			this.Par.Properties[key] = com.Default;
			com.Value = com.Default;
			fun(null, com);
			return;
		}
	}
