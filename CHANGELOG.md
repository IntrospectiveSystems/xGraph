...
## [1.6.3]
## [1.6.2]
- Fix macro symbol not being handled in sub-processes

## [1.6.1]
- New symbol processors
- ! skips sub processing after immediate symbol
- !! skips all sub processing of symbols

## [1.6.0]
- New feature: Spawn xgraph subproccess
-   Creates websocket to handle IPC
- Added basic module communication from parent
- log.profile code flagged for removal

## [1.5.17]
- package.json fixes

## [1.5.16]
- Removed startup services spam

## [1.5.15]
- Added global sources functionality
- Added xgraph source command to cli

## [1.5.14]
- Fixed log rollover error
- Fixed errors with cache.deleteEntity

## [1.5.13]
- Various profiler fixes
- Changed profiler invocation to log.profile from log.p/pi

## [1.5.12]
- Fix for silenced profiler

## [1.5.9]
- Refactor log into logger and log
- Added support for new startup and end lifecycles

## [1.5.8]
- Improved profiling output
- Fixed bug with entity scoped log reference mismatch

## [1.5.7]
- Added profiling to Logger via log.p or log.pi
...
## [1.5.4]
- Removed extraneous console output
...
## [1.5.1]
- Added missing dependency 'fast-levenshtein'
...
## [1.4.10]
- quickfix to allow browser systems to boot
