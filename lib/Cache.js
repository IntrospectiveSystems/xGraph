...
module.exports = class CacheInterface {
	...
	async loadCache() {
		...
		let init = {}, setup = {}, start = {}, stop = {}, apexIndex = {}, entIndex = {};
		...
		log.x('EntIndex', JSON.stringify(entIndex, null, 2));
		log.x('Init', JSON.stringify(init, null, 2));
		log.x('Setup', JSON.stringify(setup, null, 2));
		log.x('Start', JSON.stringify(start, null, 2));
		log.x('Stop', JSON.stringify(stop, null, 2));

		this._entIndex = entIndex;
		this._apexIndex = apexIndex;

		return { apexIndex, init, setup, start, stop };
	}
