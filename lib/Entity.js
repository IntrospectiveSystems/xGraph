...
module.exports.Entity = class Entity {
	constructor(nxs, imp, par, log) {
		...
		this.instance.Vlt = {};
		this.instance.require = this.require;
		this.instance.send = this.send;
		this.instance.nxs = nxs;
		this.instance.genPid = this.genPid;
		this.instance.genModule = this.genModule;
		this.instance.genEntity = this.genEntity;
		this.instance.getFile = this.getFile;
	...
	dispatch(com, fun = _ => _) {
		try {
			if (com.Cmd in this.instance) {
				this.instance[com.Cmd](com, fun);
				return;
			}
			if ('*' in this.instance) {
				this.instance['*'](com, fun);
				return;
			}
			this.log.w(`${com.Cmd} not found in Entity ${this.Par.Module}`);
			fun('Nada', com);
		} catch (e) {
			this.log.e(`Error in ${this.instance.Par.Entity} Command ${com.Cmd}`);
