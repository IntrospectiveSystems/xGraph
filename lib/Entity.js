...
module.exports.Entity = class Entity {
	 ...
	 * @return {object} Svc		Object of key-value pairs {string, function}
	 */
	async getServices(nxs) {
		this.log.w('..getServices', this.Par.Module);
		return await nxs.getServices(this.Par.Services);
	}
