...
module.exports = function xGraph(__options = {}) {
	...
	this.boot = function boot() {
		return (async function (__options) {
			const log = checkFlag('logger')?__options.logger: (require('../lib/Logger.js'))(__options);
			let cacheInterface;
			 ...
			 * @param {array} services		array of Pids to send GetServices to
			 */
